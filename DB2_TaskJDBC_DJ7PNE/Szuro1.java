...
public class Szuro1 extends JFrame {
	...
	public Szuro1(SzurokLista sz, Szuro1hez kk, String also, String felso) {
		...
		btnMents.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				dbm.openFile("Szuro1.txt");
				dbm.mentesSzuro1(also, felso);
				dbm.closeFile();
